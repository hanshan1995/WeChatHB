package com.effective.android.wxrp.utils.systemui;
...
public class StatusbarHelper {
    ...
    public static void setStatusBarColor(Activity activity, @ColorInt int statusBarColor, @ColorInt int themeColor) {
